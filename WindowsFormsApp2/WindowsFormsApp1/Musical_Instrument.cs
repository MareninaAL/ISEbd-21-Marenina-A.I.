...
namespace WindowsFormsApp1
{
    public abstract class Musical_Instrument : IInstrument
    {
        ...
        protected float startPosY; // protected - доступен только наследникам 
        ...
        public virtual double Weight { protected set; get;  } // вес 

        public Color Colorbody { protected set; get; } // цвет  

        // материал ?
        public String Material { protected set; get; }

        public virtual double Price { protected set; get; } // макс цена за инструмент 
